...
def detect_injection(user_input: str) -> bool:
    ...
    INJECTION_PATTERNS = [
        ...
        r"you are now (DAN|an unrestricted AI)",
        r"system prompt",
    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response("Input blocked for security reasons.")
            
        # 2. Call topic_filter(text)
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response("Input blocked as it is not related to permitted topics.")
